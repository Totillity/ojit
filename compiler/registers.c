...
//// endregion
//
//void __attribute__((always_inline)) emit_assert_loc_i32(VLoc check_loc, struct AssemblerState* state) {
...
//}
//
//void __attribute__((always_inline)) emit_assert_instr_i32(Instruction* instr, struct AssemblerState* state) {
//    if (instr->base.type == TYPE_INT) return;
